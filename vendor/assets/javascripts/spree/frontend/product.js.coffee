Spree.ready ($) ->
  Spree.addImageHandlers = ->
    ...
    thumbnails.find('li').on 'mouseenter', (event) ->
      ...
      ($ '#main-image img').attr 'data-standard', ($ event.currentTarget).find('a').attr('href')
      ($ '#main-image a').attr 'href', ($ event.currentTarget).find('a').attr('href')

    thumbnails.find('li').on 'mouseleave', (event) ->
      ($ '#main-image img').attr 'src', ($ '#main-image').data('selectedThumb')
      ($ '#main-image img').attr 'data-standard', ($ '#main-image').data('selectedThumb')
      ($ '#main-image a').attr 'href', ($ event.currentTarget).find('a').attr('href')
  ...
  Spree.showVariantImages = (variantId) ->
    ...
    if not currentThumb.hasClass('vtmb-' + variantId)
      ...
      ($ '#main-image img').attr 'data-standard', newImg
